...
import { ExpandMore, ExpandLess, Add, Visibility } from '@material-ui/icons';
...
function linkCreateSale(asso_id = null) {
    return {
                ...
                <React.Fragment key={id}>
                    ...
                    <Collapse in={Boolean(isOpen[id])} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding classes={{ root: classes.nested }}>
                            ...
                            <NavListItem to={linkCreateSale(asso.id)}>
                                <ListItemText primary="Créer une vente" />
                                <ListItemSecondaryAction>
                                    <NavIconButton edge="end" aria-label="add-sale" to={linkCreateSale(asso.id)}>
                                        <Add />
                                    </NavIconButton>
                                </ListItemSecondaryAction>
                            </NavListItem>
